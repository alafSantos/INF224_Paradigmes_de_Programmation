...
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{classSocket_acd3cb39bc957be2f34c91b9e262e1cec}{Socket}} (int type=S\+O\+C\+K\+\_\+\+S\+T\+R\+E\+AM)
\item 
\mbox{\Hypertarget{classSocket_a8e3f095dfe84d6599761c4ca54900487}\label{classSocket_a8e3f095dfe84d6599761c4ca54900487}} 
\mbox{\hyperlink{classSocket_a8e3f095dfe84d6599761c4ca54900487}{Socket}} (int type, S\+O\+C\+K\+ET sockfd)
...
S\+O\+C\+K\+ET \mbox{\hyperlink{classSocket_a1f3bad4217fea24f81d39f57406a0ec8}{descriptor}} ()
...
S\+O\+C\+K\+S\+I\+ZE \mbox{\hyperlink{classSocket_aadd260f15afadf0c31fa3dcf88d0ea49}{send}} (const S\+O\+C\+K\+D\+A\+TA $\ast$buf, size\+\_\+t len, int flags=0)
\item 
S\+O\+C\+K\+S\+I\+ZE \mbox{\hyperlink{classSocket_a01b463d51433a10658854446bde71c40}{receive}} (S\+O\+C\+K\+D\+A\+TA $\ast$buf, size\+\_\+t len, int flags=0)
\item 
\mbox{\Hypertarget{classSocket_aef5c4ba848f475f117b89bac531ac150}\label{classSocket_aef5c4ba848f475f117b89bac531ac150}} 
S\+O\+C\+K\+S\+I\+ZE \mbox{\hyperlink{classSocket_aef5c4ba848f475f117b89bac531ac150}{send\+To}} (void const $\ast$buf, size\+\_\+t len, int flags, S\+O\+C\+K\+A\+D\+DR const $\ast$to, socklen\+\_\+t addrlen)
...
S\+O\+C\+K\+S\+I\+ZE \mbox{\hyperlink{classSocket_aa19f1c03af97458c042880c6be638151}{receive\+From}} (void $\ast$buf, size\+\_\+t len, int flags, S\+O\+C\+K\+A\+D\+DR $\ast$from, socklen\+\_\+t $\ast$addrlen)
...
\begin{DoxyCompactList}\small\item\em Set the size of the T\+C\+P/\+IP input buffer. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Enable/disable the S\+O\+\_\+\+R\+E\+U\+S\+E\+A\+D\+DR socket option. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Set the size of the T\+C\+P/\+IP output buffer. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Enable/disable S\+O\+\_\+\+L\+I\+N\+G\+ER with the specified linger time in seconds. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Enable/disable S\+O\+\_\+\+T\+I\+M\+E\+O\+UT with the specified timeout (in milliseconds). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Enable/disable T\+C\+P\+\_\+\+N\+O\+D\+E\+L\+AY (turns on/off T\+CP coalescence). \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Return the size of the T\+C\+P/\+IP input buffer. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Return S\+O\+\_\+\+R\+E\+U\+S\+E\+A\+D\+DR state. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Return the size of the T\+C\+P/\+IP output buffer. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Return S\+O\+\_\+\+L\+I\+N\+G\+ER state and the specified linger time in seconds. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Return S\+O\+\_\+\+T\+I\+M\+E\+O\+UT value. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em Return T\+C\+P\+\_\+\+N\+O\+D\+E\+L\+AY state. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
T\+C\+P/\+IP or U\+D\+P/\+Datagram I\+Pv4 socket. A\+F\+\_\+\+I\+N\+ET connections following the I\+Pv4 Internet protocol are supported. \begin{DoxyNote}{Note}

\begin{DoxyItemize}
\item \mbox{\hyperlink{classServerSocket}{Server\+Socket}} should be used on the server side.
\item S\+I\+G\+P\+I\+PE signals are ignored when using Linux, B\+SD or M\+A\+C\+O\+SX.
\item T\+C\+P/\+IP sockets do not preserve record boundaries but \mbox{\hyperlink{classSocketBuffer}{Socket\+Buffer}} solves this problem. 
\end{DoxyItemize}
\end{DoxyNote}
...
Creates a new \mbox{\hyperlink{classSocket}{Socket}}. Creates a A\+F\+\_\+\+I\+N\+ET socket using the I\+Pv4 Internet protocol. Type can be\+:
\begin{DoxyItemize}
\item S\+O\+C\+K\+\_\+\+S\+T\+R\+E\+AM (the default) for T\+C\+P/\+IP connected stream sockets
\item S\+O\+C\+K\+\_\+\+D\+G\+R\+AM for U\+D\+P/datagram sockets (available only or Unix/\+Linux) 
\end{DoxyItemize}
...
Connects the socket to an address. Typically used for connecting T\+C\+P/\+IP clients to a \mbox{\hyperlink{classServerSocket}{Server\+Socket}}. On Unix/\+Linux host can be a hostname, on Windows it can only be an IP address. \begin{DoxyReturn}{Renvoie}
...
{\footnotesize\ttfamily S\+O\+C\+K\+S\+I\+ZE Socket\+::receive (\begin{DoxyParamCaption}\item[{S\+O\+C\+K\+D\+A\+TA $\ast$}]{buf,  }\item[{size\+\_\+t}]{len,  }\item[{int}]{flags = {\ttfamily 0} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

Receives data from a connected (T\+C\+P/\+IP) socket. Reads at most {\itshape len} bytes fand stores them in {\itshape buf}. By default, this function blocks the caller until thre is availbale data. \begin{DoxyReturn}{Renvoie}
...
{\footnotesize\ttfamily S\+O\+C\+K\+S\+I\+ZE Socket\+::send (\begin{DoxyParamCaption}\item[{const S\+O\+C\+K\+D\+A\+TA $\ast$}]{buf,  }\item[{size\+\_\+t}]{len,  }\item[{int}]{flags = {\ttfamily 0} }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}

Send sdata to a connected (T\+C\+P/\+IP) socket. Sends the first {\itshape len} bytes in {\itshape buf}. \begin{DoxyReturn}{Renvoie}
...
\end{DoxyReturn}
\begin{DoxyNote}{Note}
T\+C\+P/\+IP sockets do not preserve record boundaries, see \mbox{\hyperlink{classSocketBuffer}{Socket\+Buffer}}. 
\end{DoxyNote}
...
\item 
/home/alaf/\+Desktop/\+P2/\+I\+N\+F224/\+I\+N\+F224\+\_\+\+Paradigmes\+\_\+de\+\_\+\+Programmation/cpp/ccsocket.\+h\item 
